...
CREATE TABLE sections (
    id integer NOT NULL,
    year integer,
    term character varying(255) DEFAULT ''::character varying,
    course_code character varying(255),
    section_code character varying(255) DEFAULT ''::character varying,
    long_name character varying(255) DEFAULT ''::character varying,
    ...
    program character varying(255) DEFAULT ''::character varying,
    credit_type character varying(255) DEFAULT ''::character varying,
    ...
    drops integer,
    waitlist integer,
    enrollment_status character varying(255) DEFAULT 'open'::character varying,
    ext_id integer,
    ext_creator_ref character varying(255) DEFAULT ''::character varying,
    imported_by integer,
    event_type character varying(255) DEFAULT ''::character varying,
    uuid character varying(255) DEFAULT ''::character varying,
    event_status character varying(255) DEFAULT ''::character varying,
    department_code character varying(255) DEFAULT ''::character varying,
...
--
-- Name: index_comments_on_section_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_comments_on_section_id ON comments USING btree (section_id);
...
--
-- Name: index_schedules_on_section_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_schedules_on_section_id ON schedules USING btree (section_id);


--
-- Name: index_schedules_on_starts_at; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_schedules_on_starts_at ON schedules USING btree (starts_at);


--
-- Name: index_sections_on_hr_site_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_sections_on_hr_site_id ON sections USING btree (hr_site_id);
...
--
-- Name: fk_rails_ab919b3a3c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY comments
    ADD CONSTRAINT fk_rails_ab919b3a3c FOREIGN KEY (section_id) REFERENCES sections(id);
...
INSERT INTO schema_migrations (version) VALUES ('20160204191551');
